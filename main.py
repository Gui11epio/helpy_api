...
def predict():
    ...
    variaveis_de_problemas = ['filtro_oleo', 'óleo_motor', 'filtro_ar', 'filtro_combustível', 'vela_ignição', 'fluido_freio', 'pastilhas_freio', 'embreagem']  # Coloque aqui os nomes das colunas que indicam problemas
